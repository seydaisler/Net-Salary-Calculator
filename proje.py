...
def calculateTaxCategory():
    taxCategory=(input('What is your tax category?\n'))
    if int(taxCategory)>5 or int(taxCategory)<=0:
        print('print enter a valid value')
        return calculateTaxCategory()
    taxCategoryPercentages={'1':2.8, '2':3.4, '3':4.8, '4':5.2, '5':6.1}

    return (taxCategoryPercentages.get(taxCategory))
...
netto=calculateTax()
print('Your yearly net salary is', (netto))
